...
public class CustomResponseMetadataTest {
    ...
    public static void setUp() throws IOException {
        File serviceModelFile = new File(AwsModelSpecTest.class.getResource("service-2.json")
                                                                         .getFile());
        File customizationConfigFile = new File(CustomResponseMetadataTest.class
    ...
    public void responseMetadataGeneration() {
        CustomResponseMetadataSpec spec = new CustomResponseMetadataSpec(intermediateModel);
        assertThat(spec, generatesTo("./customresponsemetadata/" + spec.className().simpleName().toLowerCase() + ".java"));

        AwsServiceBaseResponseSpec responseSpec = new AwsServiceBaseResponseSpec(intermediateModel);
