...
/**
 * Generate Custom ResponseMetadata class
 */
public class CustomResponseMetadataSpec implements ClassSpec {
    private Map<String, String> headerMetadata;
    private PoetExtensions poetExtensions;

    public CustomResponseMetadataSpec(IntermediateModel model) {
        this.headerMetadata = model.getCustomizationConfig().getCustomResponseMetadata();
    ...
    private List<MethodSpec> metadataMethods() {
        return headerMetadata.keySet()
                             .stream()
                             .map(key -> MethodSpec.methodBuilder(convertMethodName(key))
    ...
    public ClassName className() {
        return poetExtensions.getCustomResponseMetadataClass();
    }
}
